...
INSERT INTO roles (name)
SELECT 'ROLE_PADRE' WHERE NOT EXISTS (SELECT 1 FROM roles WHERE name = 'ROLE_PADRE');
INSERT INTO roles (name)
SELECT 'ROLE_ALUMNO' WHERE NOT EXISTS (SELECT 1 FROM roles WHERE name = 'ROLE_ALUMNO');
