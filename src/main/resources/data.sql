...
SELECT 'PROFESOR' WHERE NOT EXISTS (SELECT 1 FROM roles WHERE name = 'PROFESOR');
INSERT INTO roles (name)
SELECT 'PADRE' WHERE NOT EXISTS (SELECT 1 FROM roles WHERE name = 'PADRE');
INSERT INTO roles (name)
SELECT 'ALUMNO' WHERE NOT EXISTS (SELECT 1 FROM roles WHERE name = 'ALUMNO');
